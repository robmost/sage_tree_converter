...
- **STATE 1 (Initialization & Discovery):** Perform file inspection and check `format-database/` for priors. **GATE:** Proceed to STATE 2 when analysis is complete.
...
- **STATE 3 (Test Engine):** Write conversion mappings. Process a small/fast dataset variant. Generate `0_test_sage_tree_<name>.hdf5`. **GATE:** Natively execute and pass every validation checklist step on this sample.
