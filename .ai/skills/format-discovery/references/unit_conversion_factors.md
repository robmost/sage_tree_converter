...
| From | To | Factor |
| ---- | -- | ------ |
| Msun/h | 10^10 Msun/h | x 1e-10 |
| Msun | 10^10 Msun/h (with h) | x h / 1e10 |
| 10^10 Msun/h | Msun/h | x 1e10 |
...
| (Mpc/h)(km/s) | **(kpc/h)(km/s)** | x 1e3 |
| Total J in Msun/h x Mpc/h x km/s | **(kpc/h)(km/s)** | / (Mvir in Msun/h) then x 1e3 |
...
For Rockstar: `J` is total angular momentum in Msun/h x Mpc/h x km/s.
